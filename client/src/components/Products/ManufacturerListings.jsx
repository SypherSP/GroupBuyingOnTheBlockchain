                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className={`text-red-700 border border-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:text-red-500 dark:border-red-500 dark:focus:ring-red-900 ${
                          !listing.isOpen
