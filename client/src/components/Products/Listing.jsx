  ...
  <div className="flex flex-col items-center bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl md:flex-row md:max-w-xl hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <div className="flex flex-col justify-between p-4 leading-normal">
      <div className="flex items-center">
        ...
        <div className="mb-3 font-medium text-gray-800 dark:text-gray-200">{description}</div>
      </div>
      <div className="flex items-center">
        <div className="text-xl mr-2 text-green-600 dark:text-green-400">-{discount}%</div>
        <div className="text-xl font-bold text-gray-900 dark:text-gray-100">${price}</div>
      </div>
      <div className="text-gray-800 dark:text-gray-200">Contact Manufacturer: {contact}</div>
      ...
      <div className="flex justify-between">
        <div className="flex content-center">
          ...
          <div className="text-xl ml-2 text-gray-800 dark:text-gray-200">${totalPrice.toFixed(2)}</div>
        </div>
        <div className="text-gray-800 dark:text-gray-200">total savings: ${totalSavings.toFixed(2)}</div>
      </div>
      <div className="mt-2">
        <button
          type="button"
